# Дипломная доработка в проект

- Папка infrastructure содержит всю необходимую инфраструктуру для автоматизированного развертывания в Yandex.Cloud с CI/CD и другими необходимыми сервисами
- По инфраструктуре проекта читать отдельный файл [README.md](./infrastructure/README.md)


# Todo List API

- Полнофункциональное приложение для управления списком задач, построенное с использованием FastAPI, PostgreSQL и Vue.js.
- Исходный репозиторий https://github.com/a1manz0/todo-fastapi
